...
public class PlantDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Plant> plants = Arrays.asList(
            ...
            new Plant("Spider Plant", "🕸️", "Air Purifying",
            ...
            new Plant("Snake Plant (Sansevieria)", "⚔️", "Air Purifying",
            ...
            new Plant("Ashwagandha", "⚗️", "Medicinal",
            ...
            new Plant("Neem", "🛡️", "Medicinal & Ornamental",
